...
- `aj_sr04m_read_all(int16_t *distances, aj_sr04m_dist_status_t *statuses, int max_sensors, int *out_sensor_count)` — read every sensor into caller-provided arrays.
